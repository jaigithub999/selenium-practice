...
public class Day9Q1 {
	public static void main(String[] args) throws AWTException, InterruptedException {
		...
		Robot r = new Robot();
			...
			WebElement findElement = driver.findElement(By.xpath("//div[text()='Uttar Pradesh']"));
			String text = findElement.getText();
			System.out.println("Add Option State:"+text);
			...
			r.keyPress(KeyEvent.VK_ENTER);
			r.keyRelease(KeyEvent.VK_ENTER);
			WebElement findElement2 = driver.findElement(By.xpath("//div[text()='Lucknow']"));
			String text2 = findElement2.getText();
			System.out.println("Add Option City :"+text2);
